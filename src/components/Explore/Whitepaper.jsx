...
const Whitepaper = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-[#2789a6]/10">

      {/* HERO */}
      <header className="relative overflow-hidden bg-gradient-to-r from-[#2789a6] via-[#1f6f86] to-[#2789a6] text-white">
        <div className="absolute inset-0 bg-black/20 backdrop-blur-[2px]" />

        <div className="relative container mx-auto px-4 py-20 text-center max-w-4xl">

          <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-[#cdeff6]">
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            <button className="bg-white text-[#2789a6] px-6 py-3 rounded-xl font-semibold flex items-center gap-2 hover:shadow-lg">
      ...
      <section className="py-20 container mx-auto px-4 max-w-5xl">
        ...
        <div className="bg-white rounded-2xl shadow p-6">
          <p className="text-slate-600 mb-6">
            ...
            <span className="font-semibold text-[#2789a6]">
              one square foot
            </span>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Feature icon={<TrendingUp />} title="Valuation Link" desc="Token value rises with sq.ft price" />
            <Feature icon={<Square />} title="Tokenization" desc="1 sq.ft = 100 tokens" />
            <Feature icon={<Shield />} title="Economic Rights" desc="Income + capital gains" />
            <Feature icon={<Building2 />} title="SPV Structure" desc="Each asset isolated legally" />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-100">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {assets.map((item, i) => (
              <div key={i} className="bg-white p-5 rounded-xl shadow hover:shadow-lg transition">
                <div className="text-[#2789a6] mb-2">{item.icon}</div>
          ...
          <div className="mt-8 flex gap-3 items-start bg-[#2789a6]/10 p-4 rounded-xl">
            <MapPin className="text-[#2789a6]" />
      ...
      <section className="py-20 container mx-auto px-4 max-w-5xl text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {steps.map((item, i) => (
            <div key={i} className="bg-white p-6 rounded-xl shadow relative hover:shadow-lg transition">
              <span className="absolute top-3 right-4 text-[#2789a6]/20 text-4xl font-bold">
                {item.step}
              </span>

              <div className="text-[#2789a6] mb-4">{item.icon}</div>
              <h3 className="font-semibold">{item.title}</h3>
              <p className="text-sm text-gray-500">{item.desc}</p>
            </div>
          ))}
        ...
        <div className="mt-10 bg-[#2789a6] text-white px-6 py-3 rounded-lg inline-block text-sm">
          Example: 100 sq.ft → 10,000 tokens → Trade anytime
        </div>
      </section>

      {/* REVENUE */}
      <section className="py-20 bg-[#2789a6] text-white text-center">
      ...
      <section className="py-20 text-center">
        ...
        <button className="bg-[#2789a6] text-white px-6 py-3 rounded-xl flex items-center gap-2 mx-auto hover:shadow-lg">
...
const Feature = ({ icon, title, desc }) => (
  <div className="flex gap-3 items-start">
    <div className="text-[#2789a6]">{icon}</div>
    <div>
